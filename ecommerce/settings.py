...
SECRET_KEY = 'django-insecure-wia^sy-_s=)@&d#@r-p$kxc(p-9vs&*2+jla*$=6iu+(pydf&u_uuhftg549'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.views.categories', #  Updated View
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'static/media'  # não colocar / antes do static
